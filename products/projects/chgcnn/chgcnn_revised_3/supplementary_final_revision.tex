...
\end{equation}
with $R$ the range of values and $N$ the number of runs (here, 5 for the 5 folds). Furthermore, the test set performance for each fold is tabulated below. Furthermore, in the following, $\bar{x}$ denotes the average of the values in the column above. These results are shown in Tables S2-S10 below. Note that in the following the bond-only results reported are CGCNN's \cite{cgcnn} reported MatBench results since our code is implemented directly into CGCNN's publicly available source code.
...
\begin{center}
	...
	\end{tabular}
\end{center}
\caption{Performance across the 5 MatBench test folds  on 18,928 materials of the perovskite formation energy target set.}
\end{table}
...
\begin{center}
	\begin{tabular}{|c|c|c|c|}
		...
		$\Delta x$ &1.9$\times$10$^{-3}$& 1.2$\times$10$^{-3}$& 0.7$\times$10$^{-3}$\\
		\hline
	\end{tabular}
\end{center}
\caption{Performance across the 5 MatBench test folds on 10,987 materials of the bulk moduli target set.}
\end{table}
...
\begin{center}
	\begin{tabular}{|c|c|c|c|}
		...
		Fold & Bond-only & Bond \& Motif & Bond \& Triplet\\
		\hline
		1 & 0.0870&0.0805 &0.0840 \\
		2 & 0.0899&0.0815&0.0866 \\
		3 & 0.0887&0.0817&0.0853 \\
		4 & 0.0902&0.0797&0.0825 \\
		5 & 0.0918&0.0813&0.0844\\
		\hline
		$\bar{x}$ &0.0895 &0.0809 & 0.0846 \\
		$\Delta x$ &11$\times$10$^{-4}$& 4$\times$10$^{-4}$& 9$\times$10$^{-4}$\\
		\hline
	\end{tabular}
\end{center}
\caption{Performance across the 5 MatBench test folds on 10,987 materials of the  shear moduli target set.}
\end{table}
...
\begin{center}
	...
	\end{tabular}
\end{center}
\caption{Performance across the 5 MatBench test folds on 1,265 materials of the  phonon peak target set.}
\end{table}
...
\begin{center}
	\begin{tabular}{|c|c|c|c|}
		...
		$\Delta x$ &0.058 & 0.043 & 0.051\\
		\hline
	\end{tabular}
\end{center}
\caption{Performance across the 5 MatBench test folds on 4,764 materials of the dielectric constant target set.}
\end{table}
...
\begin{center}
	...
	\end{tabular}
\end{center}
\caption{Performance across the 5 MatBench test folds on the exfoliation energy target set for a set of 626 2D materials (labelled Jdft2d by MatBench).}
\end{table}
...
\begin{center}
	...
	\end{tabular}
\end{center}
\caption{Performance across the 5 MatBench test folds on 106,113 materials of the Materials Project band gap target set.}
\end{table}
...
\begin{center}
	...
	\end{tabular}
\end{center}
\caption{Performance across the 5 MatBench test folds on 132,752 materials of the Materials Project formation energy target set.}
\end{table}
...
\begin{center}
	\begin{tabular}{|c|c|c|}
		...
		\hline
		$\bar{x}$ &0.953&0.958 \\
		$\Delta x$ & 4$\times$10$^{-3}$&1 $\times$10$^{-3}$\\
		\hline
		\end{tabular}
\end{center}
\caption{Performance across the 5 MatBench test folds on 106,113 materials of the Materials Project metallicity target set.}
\end{table}
