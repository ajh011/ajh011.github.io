...
Hidden node features were of dimension 64 through all convolutional layers, and a hidden output layer of dimension 128 was used (similar to CGCNN's architecture). The loss functions utilized were Mean Squared Error (MSE, for regression tasks) and cross entropy (for classification tasks). Accuracy is then reported in Mean Absolute Error (MAE) for regression tasks and area under curve (AUC) for classification tasks. \textcolor{black}{For convenience, these parameters are summarized in table \ref{hyperparameters}.}
...
\end{tabular}
\end{center}}
\caption{\textcolor{black}{Tabulated hyperparameters used for model with reported results.}}\label{hyperparameters}
\end{table}
...
\end{center}
\caption{\textcolor{black}{Figure tabulating the number of hyperedges of each type for increasing supercell size. The example material here is Manganese Oxide (MnO$_2$).} }\label{message_scaling_fig}
\end{figure}
...
\begin{center}\textcolor{black}{
	...
	\end{tabular}}
\end{center}
\caption{\textcolor{black}{Performance across the 5 MatBench test folds  on 18,928 materials of the perovskite formation energy target set.}}
\end{table}
...
\begin{center}\textcolor{black}{
	...
	\end{tabular}}
\end{center}
\caption{\textcolor{black}{Performance across the 5 MatBench test folds on 10,987 materials of the bulk moduli target set.}}
\end{table}
...
\begin{center}\textcolor{black}{
	...
	\end{tabular}}
\end{center}
\caption{\textcolor{black}{Performance across the 5 MatBench test folds on 10,987 materials of the  shear moduli target set.}}
\end{table}
...
\begin{center}\textcolor{black}{
	...
	\end{tabular}}
\end{center}
\caption{\textcolor{black}{Performance across the 5 MatBench test folds on 1,265 materials of the  phonon peak target set.}}
\end{table}
...
\begin{center}\textcolor{black}{
	...
	\end{tabular}}
\end{center}
\caption{\textcolor{black}{Performance across the 5 MatBench test folds on 4,764 materials of the dielectric constant target set.}}
\end{table}
...
\begin{center}\textcolor{black}{
	...
	\end{tabular}}
\end{center}
\caption{\textcolor{black}{Performance across the 5 MatBench test folds on the exfoliation energy target set for a set of 626 2D materials (labelled Jdft2d by MatBench).}}
\end{table}
...
\begin{center}\textcolor{black}{
	...
	\end{tabular}}
\end{center}
\caption{\textcolor{black}{Performance across the 5 MatBench test folds on 106,113 materials of the Materials Project band gap target set.}}
\end{table}
...
\begin{center}\textcolor{black}{
	...
	\end{tabular}}
\end{center}
\caption{\textcolor{black}{Performance across the 5 MatBench test folds on 132,752 materials of the Materials Project formation energy target set.}}
\end{table}
...
\begin{center}\textcolor{black}{
	\begin{tabular}{|c|c|c|}
		...
		\end{tabular}}
\end{center}
\caption{\textcolor{black}{Performance across the 5 MatBench test folds on 106,113 materials of the Materials Project metallicity target set.}}
\end{table}
