...
class CrystalGraphDataset(Dataset):
    def __init__(self, root_dir, radius=8.0, step=0.1, process_dir='cgraphs'):
    ...
    def process(self):
        idx = 0
        for cif_id, target = self.raw_data:
            ...
            torch.save(data, osp.join(self.process_dir, f'data_{idx}.pt'))
            idx += 1
        
    def get(self, idx):
        data = torch.load(osp.join(self.process_dir, f'data_{idx}.pt'))
        return data
